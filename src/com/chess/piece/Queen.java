...
public class Queen extends AbstractPiece implements Movable {
    ...
    public void makeMove(Square square) {
        ...
        this.currentSquare.setOccupied(false); // setting the former square Unoccupied
        this.setCurrentSquare(square); // setting the current square for the piece
        square.setCurrentPiece(this); // setting the current piece for the square
        square.setOccupied(true); // setting the new square occupied
    }
}